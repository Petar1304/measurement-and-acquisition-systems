...
from PyQt5.QtWidgets import QApplication, QMainWindow, QPushButton, QLabel, QLineEdit, QWidget  # QVBoxLayout
import sys
from PyQt5.QtCore import QObject, QThread, pyqtSignal # , pyqtSlot

# path variables
PORT = 'COM6'#'dev/tty/ACM0'
IN_FILE_PATH = 'C:/Users/marko/Downloads/pera/PM/sketch_jun23a/IDbaza.txt'
OUT_FILE_PATH = 'C:/Users/marko/Downloads/pera/PM/sketch_jun23a/provalnici.txt'
    ...
    def run(self):
        ...
        try:
            ...
            while True:
                ...
                max_people_in_bank = int(data_dict['voltage']) * 4
                ...
                # provera dodira
                if data_dict['touch'] == 1 and (not first_door) and (self.num_people < max_people_in_bank): #   and self.known_id: #  and self.known_id
